...
const ChatList: React.FC<ChatListProps> = ({ type }) => {
  const { chats, setActiveChat, activeChat, addMockData } = useChatStore();
    ...
    <div className={`w-full lg:w-80 ${isDark ? 'bg-gray-900' : 'bg-white'} border-r ${isDark ? 'border-gray-800' : 'border-gray-200'} flex flex-col`}>
      <div className="p-4 border-b border-gray-200 dark:border-gray-800">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="p-2 rounded-lg bg-gradient-to-r from-purple-500 to-blue-600 text-white hover:shadow-lg transition-all duration-200">
